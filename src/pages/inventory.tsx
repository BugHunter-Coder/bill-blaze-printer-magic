      ...
      {showRestriction && (
        <Alert className="mb-6 border-red-200 bg-red-50 flex items-center justify-between">
          <AlertDescription className="text-red-800">
            <b>Your shop does not have an active subscription.</b> Inventory management is restricted. <Button size="sm" className="ml-2" onClick={() => navigate('/subscription')}>Subscribe Now</Button>
          </AlertDescription>
        </Alert>
      )}
